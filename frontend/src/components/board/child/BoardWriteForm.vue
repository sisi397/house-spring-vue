...
export default {
  ...
  created() {
    if (this.type === "modify") {
      ...
      // this.$store.dispatch("getArticle", articleno).then(() => {
      ...
      // this.article = this.$store.module
      this.isUserid = true;
    }
  },
  methods: {
